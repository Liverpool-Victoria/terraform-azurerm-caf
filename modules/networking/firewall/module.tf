...
resource "azurerm_firewall" "fw" {
  ...
  dynamic "ip_configuration" {
    ...
    content {
      ...
      public_ip_address_id = try(ip_configuration.value.public_ip_id, null) != null ? ip_configuration.value.public_ip_id : var.public_ip_addresses[try(ip_configuration.value.lz_key, var.client_config.landingzone_key)][ip_configuration.value.public_ip_key].id
