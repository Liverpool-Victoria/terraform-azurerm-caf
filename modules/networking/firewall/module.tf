...
resource "azurerm_firewall" "fw" {
  ...
  dynamic "ip_configuration" {
    ...
    content {
      ...
      public_ip_address_id = can(ip_configuration.value.public_ip_id) || can(ip_configuration.value.public_ip_key) == false  ? try(ip_configuration.value.public_ip_address_id, null) : var.public_ip_addresses[try(ip_configuration.value.lz_key, var.client_config.landingzone_key)][ip_configuration.value.public_ip_key].id
