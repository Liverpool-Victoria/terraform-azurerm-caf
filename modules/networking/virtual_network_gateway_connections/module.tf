...
data "azurerm_key_vault_secret" "shared_key" {
  ...
  key_vault_id = try(
    ...
    try(var.keyvaults[var.settings.shared_key_secret_name.lz_key][var.settings.shared_key_secret_name.keyvault_key].id, var.keyvaults[var.client_config.landingzone_key][var.settings.shared_key_secret_name.keyvault_key].id)
  )
}
#data "azurerm_key_vault_secret" "shared_key" {
