  ...
  dynamic "network_rule_set" {
    ...
    content {
      ...
      dynamic "network_rules" {
        for_each = try(network_rule_set.value.network_rules, try(network_rule_set.value.subnets, {}))
        ...
        content {
          ...
          ignore_missing_vnet_service_endpoint = try(network_rules.value.ignore_missing_vnet_service_endpoint, try(network_rules.value.ignore_missing_vnet_service_endpoint, null))
        }
      }
    }
  }
