...
resource "azurerm_servicebus_queue" "queue" {
  ...
  batched_operations_enabled              = try(var.settings.batched_operations_enabled, try(var.settings.enable_batched_operations, null))
  express_enabled                         = try(var.settings.express_enabled, try(var.settings.enable_express, null))
  partitioning_enabled                    = try(var.settings.partitioning_enabled, try(var.settings.enable_partitioning, null))
